...
const POST_URL = 'https://shashankanchuri.space/blog/anthropic-four-day-sprint'
...
for (const contact of contacts) {
  const { error } = await resend.emails.send({
    ...
    to: contact.email,
    subject: "Anthropic had one of those weeks. Four days, four layers, one direction.",
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#111;border-radius:8px;padding:40px;max-width:560px;width:100%;">
        <tr><td>
          ...
          <h1 style="margin:0 0 8px;font-size:22px;color:#f5f5f5;font-weight:600;line-height:1.3;">Anthropic's Four-Day Sprint</h1>
          <p style="margin:0 0 24px;font-size:14px;color:#FF6B00;font-weight:500;">What Actually Shipped in April 2026</p>

          <p style="margin:0 0 20px;font-size:15px;color:#aaa;line-height:1.7;">
            Between April 13 and April 16, Anthropic completed its <strong style="color:#f5f5f5;">Microsoft Office integration</strong>, shipped a new flagship model, redesigned the desktop app from scratch, and added a Novartis CEO to its board.
          </p>
          <p style="margin:0 0 20px;font-size:15px;color:#aaa;line-height:1.7;">
            Four announcements. Four days. Four different layers of the business. Most coverage treats this as a breathless round-up. This one's for people who actually use the tools and care about the implementation details.
          </p>
          <p style="margin:0 0 28px;font-size:15px;color:#aaa;line-height:1.7;">
            What changed, what it costs, and whether it holds up under real workloads.
          </p>
          ...
          <table cellpadding="0" cellspacing="0" style="border-top:1px solid #222;padding-top:24px;width:100%;">
            ...
            <tr><td>
              <p style="margin:0 0 8px;font-size:13px;color:#888;line-height:1.6;">
                → Word joins Excel + PowerPoint with shared context — no re-uploading, no re-prompting<br>
                → Claude Opus 4.7: 87.6% SWE-bench, 1M context window, new xhigh effort level, task budgets<br>
                → The tokenizer change that could affect your API costs (1.0–1.35x more tokens)<br>
                → Desktop app rebuilt for parallel agents — session sidebar, drag-and-drop workspace, integrated terminal<br>
                → Vas Narasimhan on the board — the IPO signal hiding in plain sight<br>
                → What the four layers mean together: product depth, model frontier, platform experience, governance maturity
              </p>
            </td></tr>
          </table>

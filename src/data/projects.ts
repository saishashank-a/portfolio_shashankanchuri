...
export const projects: Project[] = [
  {
    ...
    github: 'https://github.com/saishashank-a',
    featured: true,
  },
  {
  ...
  },
  {
    ...
    impact: 'Biometric-grade accuracy — 20% reduction in manual tracking effort',
    description:
      'Secure attendance automation using FaceNet embeddings with a Django web interface, user management, batch processing, and automated Excel reporting.',
    tech: ['Django', 'Python', 'FaceNet'],
    github: 'https://github.com/saishashank-a',
  },
  {

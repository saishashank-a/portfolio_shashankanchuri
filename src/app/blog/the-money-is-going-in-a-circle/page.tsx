  ...
  return (
    <main className="min-h-screen px-4 md:px-6 pt-8 pb-24">
      <div className="paper-sheet max-w-2xl mx-auto">
        ...
        {/* Header */}
        <p className="font-hand text-xl text-[var(--accent)] mb-2">Jun 2026 · AI Infrastructure</p>
        <h1 className="font-display text-[clamp(2rem,5vw,3.1rem)] font-semibold tracking-tight text-[var(--fg)] leading-[1.05] mb-4">
